...
function selectPage(obj){
	...
	window.location.href="node_list2.php?page="+pagesSelect+"&action=jump"+"&gid="+txtGid+"&keyword="+UrlEncode(txtKeyword)+"&type="+searchSelect;
}
...
function FikCdn_SearchNode(){
	...
	window.location.href="node_list2.php?page=1"+"&action=jump"+"&gid="+txtGid+"&keyword="+UrlEncode(txtKeyword)+"&type="+searchSelect;		
}
		...
		<div id="div_search_result">
		  <table width="800" border="0" class="dataintable">
			<tr>
				...
				<th align="right" width="140" align="right">15CDN 版本</th>
...
?>
		 ...
		 <table width="800" border="0" class="disc">
			...
			<td><div class="div_page_bar"> 记录总数：<?php echo $total_host;?>条&nbsp;&nbsp;&nbsp;当前第<?php echo $nPage; ?>页|共<?php echo $total_pages; ?>页&nbsp;&nbsp;&nbsp;跳转
				...
				页&nbsp;&nbsp;&nbsp;&nbsp;
				<a href="node_list2.php?page=1&action=first&gid=<?php echo $nGid.'&type='.$sType.'&keyword='.$sKeyword; ?>">首页</a>&nbsp;&nbsp;
				<a href="node_list2.php?page=<?php echo $pageup; ?>&action=pageup&gid=<?php echo $nGid.'&type='.$sType.'&keyword='.$sKeyword; ?>">上一页</a>&nbsp;&nbsp;				
				<a href="node_list2.php?page=<?php echo $pagedown; ?>&action=pagedown&gid=<?php echo $nGid.'&type='.$sType.'&keyword='.$sKeyword; ?> ">下一页</a>&nbsp;&nbsp;
				<a href="node_list2.php?page=<?php echo $total_pages; ?>&action=tail&gid=<?php echo $nGid.'&type='.$sType.'&keyword='.$sKeyword; ?>">尾页 </a></div></td>
			</tr>
		</table>	
