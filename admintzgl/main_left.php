...
<meta name="description" content="CDN 后台管理系统" />
<meta name="keywords" content=" CDN 后台管理系统" />
<title> CDN 后台管理系统</title>
<style>
...
<div id="container">
  ...
  <div class="content">
	...
	<ul class="MM">
	   ...
	   <li><a href="stat_node_bandwidth.php" target="mainFrame" onclick="OnClickNav('span_stat_node_bandwidth');"><span id='span_stat_node_bandwidth' class="LiNormal">服务器流量</span></a></li>	
	    <li><a href="group_stat_node_bandwidth.php" target="mainFrame" onclick="OnClickNav('group_stat_node_bandwidth');"><span id='group_stat_node_bandwidth' class="LiNormal">组流量</span></a></li>	  
  ...
  <div class="content">
	...
	<ul class="MM">
	  ...
	  <li><a href="stat_domain_qqs.php"target="mainFrame" onclick="OnClickNav('span_domain_qqs');" ><span id='span_domain_qqs' class="LiNormal">域名流量</span></a></li>	
	  ...
	  <li><a href="white_list.php" target="mainFrame" onclick="OnClickNav('span_white_list');"><span id='span_white_list' class="LiNormal">白名单查询</span></a></li>
	</ul>
  </div>   
...
<div id="container">
 ...
 <h1 class="type"><a href="javascript:void(0)">新闻管理</a></h1>
  <div class="content">
	...
	<ul class="MM">
	  <li><a href="news_list.php" target="mainFrame" onclick="OnClickNav('span_news_list');"><span id='span_news_list' class="LiNormal">新闻列表</span></a></li>
	</ul>
  </div>      	   
