    ...
    <td valign="top" background="../images/content-bg.gif">
	   <table width="100%" height="31" border="0" cellpadding="0" cellspacing="0" class="left_topbg" id="table2" >
			<tr height="31" class="TabToolTitle">
				<td height="31" width="85"><a href="buy_list_will_expire.php?gid=<?php echo $nGid; ?>"><span class="title_bt">将到期套餐</span></a></td>	
				<td height="31" width="85"><a href="buy_list_not_expire.php?gid=<?php echo $nGid; ?>"><span class="title_bt_active">未到期套餐</span></a></td>
				<td width="95%"></td>
			</tr>
        </table>
	</td>
