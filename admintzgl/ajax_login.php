...
if($sMod=='login')
{
	if($sAction=="logging")
	{
		...
		$admin_grade=mysql_result($result,0,"admin_grade");
		...
		mysql_close($db_link);
		$_SESSION['admin_grade']=$admin_grade;	
		...
		$_SESSION['sale_group']=$sale_group;	
		/*
		if($savepasswd=="true")
		{
		...
		*/
		...
		$aryResult = array('Return'=>'True','username'=>$sUsername,'admin_grade'=>$admin_grade,'auth_random'=>$auth_random);
		PubFunc_EchoJsonAndExit($aryResult,NULL);
	}
