...
var __sCurActiveSpanID="span_recharge_list";
...
<div id="container">
  ...
  <div class="content">
	...
	<ul class="MM">
	  <li><a href="recharge_list.php" target="mainFrame" onclick="OnClickNav('span_recharge_list');"><span id='span_recharge_list' class="LiActive">充值记录</span></a></li>
  ...
  <div class="content">
	...
	<ul class="MM">
	  <li><a href="user_list5.php" target="mainFrame" onclick="OnClickNav('span_user_list');"><span id="span_user_list" class="LiNormal">用户列表</span></a></li>
