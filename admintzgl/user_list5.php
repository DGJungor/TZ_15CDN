<?php
	...
	if(($_SESSION['admin_grade']==2)||($_SESSION['admin_grade']==3)||($_SESSION['admin_grade']==4)){
...
function FikCdn_ModifyUserBox(uid)
{
	...
	showMSGBOX('',500,420,BT,BL,120,boxURL,'操作提示:');		
}
...
function selectPage(obj){
	...
	window.location.href="user_list5.php?page="+pagesSelect+"&action=ump&type="+UrlEncode(searchSelect) +"&keyword="+UrlEncode(txtKeyword);
}
...
function fiknode_search(){
	...
	window.location.href="user_list5.php?page=1&action=ump"+"&type="+UrlEncode(searchSelect) +"&keyword="+UrlEncode(txtKeyword);
  ...
  <tr height="500">
	  ...
	  <td valign="top">
		...
		<div id="div_search_result">	
		  <table width="800" border="0" class="dataintable">
			<tr>
				<th align="center" width="80" align="center">关联业务员</th>
				<th align="center" width="100">用户帐号</th>
				<th align="center" width="80">姓名</th> 
				<th align="center" width="155" align="center">公司名称</th>
				
				<!-- <th align="center" width="80" align="center">业务员分组</th>
				<th align="center" width="90">联系电话</th>
				<th align="center" width="90">QQ号</th>	 -->
				<th align="center" width="50">账户余额(元)</th>
...
?>	 
		 ...
		 <table width="800" border="0" class="disc">
			...
			<td bgcolor="#FFFFE6"><div class="div_page_bar"> 记录总数：<?php echo $total_host;?>条&nbsp;&nbsp;&nbsp;当前第<?php echo $nPage; ?>页|共<?php echo $total_pages; ?>页&nbsp;&nbsp;&nbsp;跳转
				...
				页&nbsp;&nbsp;&nbsp;&nbsp;<a href="user_list5.php?page=1&action=first<?php echo '&type='.$sType.'&keyword='.$sKeyword; ?>">首页</a>&nbsp;&nbsp;
				<a href="user_list5.php?page=<?php echo $pageup.'&type='.$sType.'&keyword='.$sKeyword; ?>&action=pageup">上一页</a>&nbsp;&nbsp;				
				<a href="user_list5.php?page=<?php echo $pagedown.'&type='.$sType.'&keyword='.$sKeyword; ?>&action=pagedown">下一页</a>&nbsp;&nbsp;
				<a href="user_list5.php?page=<?php echo $total_pages.'&type='.$sType.'&keyword='.$sKeyword; ?>&action=tail">尾页 </a></div></td>
			</tr>
		</table>	
	  </td> 
