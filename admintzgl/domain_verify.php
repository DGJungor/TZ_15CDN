...
?>
         ...
         <table width="800" border="0" class="disc">
			...
			<div class="div_page_bar"> 记录总数：<?php echo $total_host;?>条&nbsp;&nbsp;&nbsp;当前第<?php echo $nPage; ?>页|共<?php echo $total_pages; ?>页&nbsp;&nbsp;&nbsp;跳转
				...
				页&nbsp;&nbsp;&nbsp;&nbsp;<a href="domain_verify.php?page=1&action=first">首页</a>&nbsp;&nbsp;
				<a href="domain_verify.php?page=<?php echo $pageup; ?>&action=pageup">上一页</a>&nbsp;&nbsp;				
				<a href="domain_verify.php?page=<?php echo $pagedown; ?>&action=pagedown">下一页</a>&nbsp;&nbsp;
				<a href="domain_verify.php?page=<?php echo $total_pages; ?>&action=tail">尾页 </a></div></td>
			</tr>
		</table>	
    </form>
  </div>
