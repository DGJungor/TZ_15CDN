...
function getNodeBandwidthStatData(group_id,timeval)
{
	...
	var postUrl = "request_stat_data1.php?mod=realtime&action=bandwidth"+"&group_id=" + group_id +"&timeval="+timeval;
...
function OnSelectNode()
{
	...
	window.location.href="group_stat_node_bandwidth.php?id="+txtSelectNode+"&date2="+nDateSelect2;
}
    ...
    <td valign="top" background="../images/content-bg.gif">
	   <table width="100%" height="31" border="0" cellpadding="0" cellspacing="0" class="left_topbg" id="table2" >
			<tr height="31" class="TabToolTitle">
				<td height="31" width="85"><a href="group_stat_node_bandwidth.php?id=<?php echo $group_id; ?>"><span class="title_bt">实时带宽</span></a></td>
...
getNodeBandwidthStatData(<?php echo $group_id; ?>,nCurBandwidthDateSelect);
</script>
<?php
