...
function selectProduct()
{
	...
	window.location.href="stat_buy_product_month4.php?buy_id="+buy_id;
    ...
    <td valign="top" background="../images/content-bg.gif">
	   <table width="100%" height="31" border="0" cellpadding="0" cellspacing="0" class="left_topbg" id="table2" >
			<tr height="31" class="TabToolTitle">
				...
				<td height="31" width="85"><a href="stat_buy_product_month4.php?buy_id=<?php  echo $buy_id; ?>"><span class="title_bt">月度流量</span></a></td>															
				<td width="95%"></td>
			</tr>
        </table>
	</td>
