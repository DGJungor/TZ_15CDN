...
function selectDomain(){
	...
	window.location.href="stat_domain_download4.php?domain_id="+txtDoaminID+"&date2="+nDateSelect2;
}
    ...
    <td valign="top" background="../images/content-bg.gif">
	   <table width="100%" height="31" border="0" cellpadding="0" cellspacing="0" class="left_topbg" id="table2" >
			<tr height="31" class="TabToolTitle">
				...
				<td height="31" width="85"><a href="stat_domain_download4.php?domain_id=<?php echo $domain_id; ?>"><span class="title_bt">日流量统计</span></a></td>
