...
<div id="container">
  ...
  <div class="content">
	...
	<ul class="MM">
	   <li><a href="node_list2.php" target="mainFrame" onclick="OnClickNav('span_node_list');"><span id='span_node_list' class="LiActive">服务器列表</span></a></li>
   	   <li><a href="group_list2.php" target="mainFrame" onclick="OnClickNav('span_group_list');"><span id='span_group_list' class="LiNormal">服务器组</span></a></li>
...
<div id="container">
  ...
  <div class="content">
	...
	<ul class="MM">
	  ...
	  <li><a href="stat_buy_product_bandwidth.php" target="mainFrame" onclick="OnClickNav('span_buy_product_bandwidth');"><span id='span_buy_product_bandwidth' class="LiNormal">套餐流量</span></a></li>	
	   <li><a href="buy_list2.php" target="mainFrame" onclick="OnClickNav('span_buy_list');"><span id='span_buy_list' class="LiNormal">售出套餐</span></a></li>  
	</ul>
  </div>  
  ...
  <div class="content">
	...
	<ul class="MM">
	  <li><a href="user_list2.php" target="mainFrame" onclick="OnClickNav('span_user_list');"><span id="span_user_list" class="LiNormal">用户列表</span></a></li>
	 </ul>
  </div>
