...
<div id="container">
  ...
  <div class="content">
	...
	<ul class="MM">
	   <li><a href="user_list3.php" target="mainFrame" onclick="OnClickNav('span_node_list');"><span id='span_node_list' class="LiActive">用户列表</span></a></li>
   	</ul>
  </div>  
...
<div id="container">
  ...
  <div class="content">
	...
	<ul class="MM">
	  ...
	  <li><a href="buy_list3.php" target="mainFrame" onclick="OnClickNav('span_buy_list');"><span id='span_buy_list' class="LiNormal">售出套餐</span></a></li>
	  <li><a href="stat_buy_product_bandwidth3.php" target="mainFrame" onclick="OnClickNav('span_buy_product_bandwidth');"><span id='span_buy_product_bandwidth' class="LiNormal">套餐流量</span></a></li>
	</ul>
  </div>  
  ...
  <div class="content">
	...
	<ul class="MM">
	  <li><a href="domain_list3.php" target="mainFrame" onclick="OnClickNav('span_domain_list');"><span id='span_domain_list' class="LiNormal">域名列表</span></a></li>
	  <li><a href="stat_domain_bandwidth3.php"target="mainFrame" onclick="OnClickNav('span_domain_bandwidth');" ><span id='span_domain_bandwidth' class="LiNormal">域名流量</span></a></li>	
	</ul>
  </div>      
