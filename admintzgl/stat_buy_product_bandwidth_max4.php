...
function selectProduct()
{
	...
	window.location.href="stat_buy_product_bandwidth_max4.php?buy_id="+buy_id+"&timeval="+nBandwidthDateSelect+"&date2="+nDateSelect2;
    ...
    <td valign="top" background="../images/content-bg.gif">
	   <table width="100%" height="31" border="0" cellpadding="0" cellspacing="0" class="left_topbg" id="table2" >
			<tr height="31" class="TabToolTitle">
				<td height="31" width="85"><a href="stat_buy_product_bandwidth4.php?buy_id=<?php  echo $buy_id; ?>"><span class="title_bt_active">实时带宽</span></a></td>
				<td height="31" width="85"><a href="stat_buy_product_bandwidth_max4.php?buy_id=<?php  echo $buy_id; ?>"><span class="title_bt">峰值带宽</span></a></td>
				<td height="31" width="85"><a href="stat_buy_product_day_download4.php?buy_id=<?php  echo $buy_id; ?>"><span class="title_bt_active">日流量统计</span></a></td>
				<td height="31" width="85"><a href="stat_buy_product_day_request4.php?buy_id=<?php  echo $buy_id; ?>"><span class="title_bt_active">日请求量统计</span></a></td>					
				<td height="31" width="85"><a href="stat_buy_product_month4.php?buy_id=<?php  echo $buy_id; ?>"><span class="title_bt_active">月度流量</span></a></td>					
				<td width="95%"></td>
			</tr>
        </table>
	</td>
...
<?php
	...
	{	
		...
		$sql = "SELECT * FROM `fikcdn_buy` WHERE sale_group='$sale_group';";
