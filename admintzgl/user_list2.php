...
function selectPage(obj){
	...
	window.location.href="user_list2.php?page="+pagesSelect+"&action=ump&type="+UrlEncode(searchSelect) +"&keyword="+UrlEncode(txtKeyword);
}
...
function fiknode_search(){
	...
	window.location.href="user_list2.php?page=1&action=ump"+"&type="+UrlEncode(searchSelect) +"&keyword="+UrlEncode(txtKeyword);
...
?>	 
		 ...
		 <table width="800" border="0" class="disc">
			...
			<td bgcolor="#FFFFE6"><div class="div_page_bar"> 记录总数：<?php echo $total_host;?>条&nbsp;&nbsp;&nbsp;当前第<?php echo $nPage; ?>页|共<?php echo $total_pages; ?>页&nbsp;&nbsp;&nbsp;跳转
				...
				页&nbsp;&nbsp;&nbsp;&nbsp;<a href="user_list2.php?page=1&action=first<?php echo '&type='.$sType.'&keyword='.$sKeyword; ?>">首页</a>&nbsp;&nbsp;
				<a href="user_list2.php?page=<?php echo $pageup.'&type='.$sType.'&keyword='.$sKeyword; ?>&action=pageup">上一页</a>&nbsp;&nbsp;				
				<a href="user_list2.php?page=<?php echo $pagedown.'&type='.$sType.'&keyword='.$sKeyword; ?>&action=pagedown">下一页</a>&nbsp;&nbsp;
				<a href="user_list2.php?page=<?php echo $total_pages.'&type='.$sType.'&keyword='.$sKeyword; ?>&action=tail">尾页 </a></div></td>
			</tr>
		</table>	
	  </td> 
