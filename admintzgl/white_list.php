...
function selectPage(obj){
	...
	window.location.href="white_list.php?page="+pagesSelect+"&action=jump"+"&buy_id="+txtBuyId+"&keyword="+UrlEncode(txtKeyword)+"&type="+searchSelect+"&selectOrder="+selectOrder;
}
...
function FikHost_Search(){
	...
	window.location.href="white_list.php?page=1"+"&action=jump"+"&buy_id="+txtBuyId+"&keyword="+UrlEncode(txtKeyword)+"&type="+searchSelect;
...
function selectGroup(){
	...
	var txtBuyId		 =document.getElementById("grpSelect").value;
	var selectOrder =document.getElementById("selectOrder").value;
	window.location.href="white_list.php?page=1"+"&action=jump"+"&buy_id="+txtBuyId+"&keyword="+UrlEncode(txtKeyword)+"&type="+searchSelect+"&selectOrder="+selectOrder;
}
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#F8F9FA">
 ...
 <td height="31" width="85"><span class="title_bt">白名单查询</span></a></td>
				<td height="31" width="100"><a href="product_node_add.php"><span class="title_bt">添加套餐节点</span></a></td>
				<td height="31" width="100"><a href="product_node_delete.php"><span class="title_bt">删除套餐节点</span></a></td>
				<td width="95%"></td>
		...
		do
		{
			...
			for($i=0;$i<$row_count;$i++)
			{
				...
				{		
					...
					{
						$product_name  		= mysql_result($result2,0,"name");
						$product_id=mysql_result($result2,0,"id");
				...
				*/
				...
				echo '<td title="'.$note.'" align="left"><a href="white_list_info.php?hostname='.$hostname.'&product_name='.$product_name.'&group_id='.$group_id.'&product_id='.$product_id.'">'.$hostname.'</a></td>';
				//echo '<td>'.$username.'</td>';
