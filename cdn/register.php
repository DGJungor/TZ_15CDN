			...
			<div class="beg-login-main">
				<form name="form1" action="" class="layui-form" method="post"> <!-- 注册提交方法 -->
					<div class="layui-form-item">
						...
						<input  style="width:180px;" id="txtUsername" name="txtUsername" type="text" maxlength="64" lay-verify="userName" autocomplete="off" placeholder="请输入用户名" class="layui-input"/>
						<span class="input_tips_txt" id="tipsUsername" ></span>
					</div>
					<div class="layui-form-item">
						<label style="float:left;font-size:18px;margin-right:20px;padding-top:5px;">密　码</label>
						<input style="width:180px;" id="txtPasswd" name="txtPasswd" type="password" maxlength="32" lay-verify="password" autocomplete="off" placeholder="请输入密码" class="layui-input"/>
						<span class="input_tips_txt" id="tipsPasswd" ></span>
					</div>
					<div class="layui-form-item">
						<label style="float:left;font-size:18px;margin-right:20px;padding-top:5px;">联系人</label>
						<input style="width:180px;" id="txtRealname" name="txtRealname" type="text" maxlength="64" lay-verify="contacter" autocomplete="off" placeholder="请输入联系人" class="layui-input"/>
						<span class="input_tips_txt" id="tipsRealname" ></span>
					</div>
					<div class="layui-form-item">
						<label style="float:left;font-size:18px;margin-right:20px;padding-top:5px;">公　司</label>
						<input style="width:180px;" id="txtCompanyName" name="txtCompanyName" type="text" maxlength="128" lay-verify="company" autocomplete="off" placeholder="请输入公司名称" class="layui-input"/>
						<span class="input_tips_txt" id="tipsCompanyName" ></span>
					</div>
					<div class="layui-form-item">
						<label style="float:left;font-size:18px;margin-right:20px;padding-top:5px;">电　话</label>
						<input style="width:180px;" id="txtPhone" name="txtPhone" type="text" maxlength="32" lay-verify="phone" autocomplete="off" placeholder="请输入联系电话" class="layui-input"/>
						<span class="input_tips_txt" id="tipsPhone" ></span>
					</div>
					
					<div class="layui-form-item">
						<label style="float:left;font-size:18px;margin-right:20px;padding-top:5px;">业务员</label>
						<select id="txtRelation" >
					...
					<div class="layui-form-item">
						...
						<input style="width:180px;" id="txtQQ" name="txtQQ" type="text" maxlength="20" lay-verify="number" autocomplete="off" placeholder="请输入QQ号码" class="layui-input"/>
						<span class="input_tips_txt" id="tipsQQ" ></span>
					</div>
					<div class="layui-form-item">
						<label style="float:left;font-size:18px;margin-right:20px;padding-top:5px;">地　址</label>
						<input style="width:180px;" id="txtAddr" name="txtAddr" type="text" maxlength="128" autocomplete="off" placeholder="请输入联系地址" class="layui-input"/>
						<span class="input_tips_txt" id="tipsAddr" ></span>
					</div>
					<div class="layui-form-item">
