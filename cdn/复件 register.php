...
<body>
    ...
    <nav class="topbar">
      <div class="topbar-inner">
        <div class="container">
                <h1 class="nav_string">15CDN 帐号注册</h1>          
        </div>
      </div>
    </nav>
        ...
        <div class="page-account-clean page-signup row">
					 <section class='span10'>
					   ...
					   <tr height="28">
						...
						<td align="center"> </td>
						<td>
						<input name="btn_register"  class="btn_string" type="submit" style="width:120px;height:32px;" value="注册" style="cursor:pointer;" onClick="OnRegisterUser();" /> 
						</td>
						</tr>
...
<div>        
    <footer>
      <p>&copy; 2016 15CDN, Inc. All rights reserved.</p>
    </footer>
</div>
<style>
