...
<div id="fikcdn_main_div">
	<div id="main_top_space">
		<div id="main_top_div">
			...
			<div id="main_top_txt"> <?php echo $fikcdn_client_nick;   ?> ！欢迎使用 C盾 后台管理系统    <a target="_blank"  href="http://wpa.qq.com/msgrd?v=3&uin=2885611879&site=qq&menu=yes" id="gfqq_1">
