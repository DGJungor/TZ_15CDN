...
<div style="margin: 15px;">
		...
		<div class="layui-tab layui-tab-card">
			<ul class="layui-tab-title">
				<a href="stat_buy_product_bandwidth.php?buy_id=<?php  echo $buy_id; ?>"><li class="layui-this">实时带宽</li></a>
			...
			<div class="layui-tab-content" style="height: 100%">
				...
				<div class="layui-tab-item layui-show">
					<div style="float: right;">
						...
						<form action="">
							...
							<label class="layui-form-label">查看的套餐</label>
								...
								if($db_link)
								{
									...
									if($result)
									{
										...
										for($i=0;$i<$row_count;$i++)
										{
											...
											if($buy_id==$this_id)
											{
												echo '<option value="'.$this_id.'" selected="selected">'.$product_name."_".$this_id."</option>";
												
												$show_this_name = $product_name."_".$this_id;
												/*$this_hostname = $hostname;*/
											}
											else
											{
												echo '<option value="'.$this_id.'">'.$product_name."_".$this_id."</option>";				
											}
										}
									}
				...
				<blockquote class="layui-elem-quote">
					实时带宽详细统计数据 - <?php echo $show_this_name; ?>
...
getCrashReportStatData(<?php echo $buy_id; ?>,nCurBandwidthDateSelect);
				...
				<table align="center">
					<tr style="height: 30px; border-bottom:1px dotted #000;text-align: right;">
						<td style="width: 220px; background-color: #eee;">24小时最大下载峰值带宽：</td>	
						<td style="width: 100px;">0 Mbps</td>
						<td style="width: 10px;"></td>
						<td style="width: 220px; background-color: #eee; ">24小时平均下载带宽：</td>
						<td style="width: 100px;">0 Mbps</td>
						<td style="width: 10px;"></td>
