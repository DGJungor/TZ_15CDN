			...
			<div class="beg-login-main">
				<form action="" class="layui-form" method="post"> <!-- 登录提交方法 -->
					<div class="layui-form-item">
						<input id="txtUsername" name="txtUsername" type="text" lay-verify="userName" autocomplete="off" placeholder="用户名" class="layui-input" size="26" maxlength="64" value="<?php echo $client_username; ?>" >

						<!--<span class="login_tips_txt" id="tipsUsername" name="tipsUsername" ></span>-->
					</div>
					<div class="layui-form-item">
						<input id="txtPassword" name="txtPassword" type="password" lay-verify="password" autocomplete="off" placeholder="密码" class="layui-input" size="26" maxlength="64">
                        <!--<span class="login_tips_txt" id="tipsPasswd" name="tipsPasswd"></span>-->
					</div>
					<div class="layui-form-item">
						<input  id="txtCheckCode" name="txtCheckCode" type="text" size="5" maxlength="6" lay-verify="code" autocomplete="off" placeholder="验证码" class="layui-input codeInput"/>
						<span id="span_check_code" style="clear:both;"><img src="../function/checkcode.php" alt="验证码" class="codeImg" onclick="javescript:ChangeCheckCode();"/></span>
