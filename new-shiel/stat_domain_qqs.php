...
function selectDomain(){
	...
	window.location.href="stat_domain_qqs.php?domain_id="+txtDoaminID+"&date2="+nDateSelect2;
}
...
function getDomainBandwidthStatData(domain_id,timeval)
{
	...
	var postUrl = "request_stat_qqs.php?mod=proxy&action=bandwidth"+"&domain_id=" + domain_id +"&timeval="+timeval;
...
<div style="margin: 15px;">
		...
		<div class="layui-tab layui-tab-card">
			<ul class="layui-tab-title">
            	<a href="stat_domain_qqs.php?domain_id=<?php echo $domain_id; ?>"><li class="layui-this">实时请求</li></a>
			...
			<div class="layui-tab-content" style="height: 100%">
				...
				<blockquote class="layui-elem-quote">
					实时请求详细统计数据 - <?php echo $this_hostname; ?>
