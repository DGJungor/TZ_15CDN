...
<div id="container">
  ...
  <div class="content">
	...
	<ul class="MM">
	  ...
	  <li><a href="stat_domain_qqs.php" onclick="OnClickNav('span_domain_bandwidth');" target="main"><span id='span_domain_bandwidth' class="LiNormal">域名流量</span></a></li>	  
  ...
  <div class="content">
	...
	<ul class="MM">
	  ...
	  <li><a href="alipay_recharge.php" target="main" onclick="OnClickNav('span_alipay_recharge');"><span id="span_alipay_recharge" class="LiNormal">在线充值</span></a></li>
