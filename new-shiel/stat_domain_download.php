...
<div style="margin: 15px;">
		...
		<div class="layui-tab layui-tab-card">
			<ul class="layui-tab-title">
				...
				<a href="stat_domain_download.php?domain_id=<?php echo $domain_id; ?>"><li  class="layui-this">日流量统计</li></a>
			...
			<div class="layui-tab-content" style="height: 100%">
				...
				<div class="layui-tab-item layui-show">
					<div style="float: right;">
						...
						<form action="">
							...
							<div class="layui-input-inline">
								 <select style="height: 37px; width: 190px; border:1px solid #e6e6e6; text-align:center" id="FlawDateSelect" onChange="OnSelectFlawDate()">
				...
				<blockquote class="layui-elem-quote">
					日流量详细统计数据 - <?php echo $this_hostname; ?></span>
