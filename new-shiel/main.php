...
<body>
		<div class="layui-layout layui-layout-admin" >
			...
			<div class="layui-header header header-demo" style="background-color: #1aa094">
				<div class="layui-main">
					
					<!-- 菜单展开/隐藏开始 -->
					<div class="admin-login-box">
						<a class="logo" style="display:block;width:95px;height:60px;top:0px;" href="#">
							<!-- 添加公司Logo或文字-->
							<!--<span style="font-size: 22px;">腾正科技</span><br />-->
							<img alt="LOGO" src="images/LOGO.png" style="width:95px;height:60px;"/>
						</a>
