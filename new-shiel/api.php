...
if($sMod=='user')
{
	if($sAction=="register")
	{
		...
		$sql = "INSERT INTO fikcdn_client(sale_group,id,username,realname,password,enable_login,register_time,register_ip,addr,phone,company_name,relation_sale,qq,note) VALUES('$belong',NULL,'$sUsername',
				'$realname','$password','1','$add_time','$client_ip','$addr','$phone','$compname','$relation_sale','$qq','');";
